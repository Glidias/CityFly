package org.cityfly.view.raycasting.andre 
{
	...
	public class AndreViewTest extends Sprite
	{
		...
		public function set camera(entity:Camera3DEntity):void {
			...
			_camPosition.x = 64 * 64 + 32;
			_camPosition.y = 64 * 64 + 32;
			_camPosition.z = 32;
		...
		public var engine: AndreRaycaster = new AndreRaycaster(320,240);
		...
		public function init():void {
			...
			buffer = new BitmapData( engine.width, engine.height );
			bmp = new Bitmap( buffer );
			bounds = new Rectangle(0,0,buffer.width, buffer.height);
