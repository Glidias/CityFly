...
class AndreRaycaster extends BitmapData
{
	...
	public var roll:Float;
		...
		public function new(width:UInt, height:UInt, transparent:Bool=false, defaultBg:UInt=0  ) 
	{
		super(width, height, transparent, defaultBg);	
	...
	private inline function randomStart():Void {
		// fill map randomly
